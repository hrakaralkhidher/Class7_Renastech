...
public class Topic5_mapExample2 {
...
topping1({"pancake": "syrup"}) → {"bread": "butter", "pancake": "syrup"}
        ...
        System.out.println(topping(MyFood));
        ...
        System.out.println("****************************");
        System.out.println(topping(MyFood2));
        ...
        System.out.println("****************************");
        System.out.println(topping(MyFood3));

    }
    public static HashMap<String, String> topping(HashMap<String, String> param1){
        //if the key "ice cream" is present,
