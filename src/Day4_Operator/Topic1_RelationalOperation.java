...
public class Topic1_RelationalOperation {
    public static void main(String[] args) {
        //"==" check if two thing are equal
        boolean check = 2 == 8;
        ...
        System.out.println("results: "+check6);

        //">= check is one thing greater than another thing or equal to it
        ...
        //"!" convert to opposite value the ! will give the oppisite answer if want to change it the put printicis.
