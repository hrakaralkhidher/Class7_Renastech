...
public class CowClass extends OldMcDonaldAnimal{
    public void Milk(){
        System.out.println(AnimalName+"You will drink Milk");
    }
    public CowClass(){NumberOfLegs = 4;}
@Override
    public void Eat(){
        super.Eat();
...
/*
//                     Private methods can not be @override    //                 Protected methods can be
////				   ONLY the instance methods can be overridden////		 @Override annotation MUST be applicable
 // static, final, abstract,sycn..    // final methods can not be override.
