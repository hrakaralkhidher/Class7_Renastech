...
public class Topic3_WhileBreak {
    public static void main(String[] args) {
        //print all the numbers beteen 1 and 10 but when the number is 5 break the loop
        ...
        while(i<name.length())
        {
            //System.out.println("the char at index "+i+" is: "+name.charAt(i));// this will print the 1st occuring a
            if(name.charAt(i)=='a')
            {
                break;
            }
