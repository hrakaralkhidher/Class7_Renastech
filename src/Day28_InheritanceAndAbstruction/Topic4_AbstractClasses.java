...
//        CreamBrule MyCreamBrule = new CreamBrule() {// you can not create a copy of an interface too
 ...
 */
//is abstract 100% abstract? No because we can have abstract methods inside/
abstract class Bakery{
    ...
    abstract void SetCream();

    public void EatSomething(){
        System.out.println("You are eating something");
    }
}
// can you have an abstract method in a none-abstract class?
